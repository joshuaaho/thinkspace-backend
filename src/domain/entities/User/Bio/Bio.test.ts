...
describe('Bio Value Object', () => {
  describe('create valid bio', () => {
    const result = Bio.create('Passionate software developer with 5 years of experience').unwrap();

    it('should have correct value', () => {
      expect(result.value).toBe('Passionate software developer with 5 years of experience');
    });
  });

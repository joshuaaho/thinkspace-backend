...
describe('Education Value Object', () => {
  describe('create valid education', () => {
    const result = Education.create('Bachelor of Science in Computer Science, University of Technology').unwrap();

    it('should have correct value', () => {
      expect(result.value).toBe('Bachelor of Science in Computer Science, University of Technology');
    });
  });
